...
let modelsAlpha = inventory.slice().sort(function(a, b) {
...
console.log("All cars sorted alphabetically by model.");

console.log("*************************************************************************");

console.log(modelsAlpha);

console.log("*************************************************************************");
console.log("*************************************************************************");

console.log("Just the models.");

console.log("*************************************************************************");

let carModels = inventory.map(x => x.car_model);
carModels.sort();
...
console.log("Here's the year of every car out there, boss!");
console.log("*************************************************************************");
...
let BMWAndAudi = inventory.filter(
  x => x.car_make == "BMW" || x.car_make == "Audi"
);

console.log("Here's the Audis and Beamers, boss!");
console.log("*************************************************************************");
